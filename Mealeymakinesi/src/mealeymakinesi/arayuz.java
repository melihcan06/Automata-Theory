...
public class arayuz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Durumlar:");

        jLabel2.setText("q0,q1,...");

        jLabel3.setText("Alfabe:");

        jLabel4.setText("Çıktılar:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        t1.input(jTextField1.getText(),jTextField2.getText(),jTextField3.getText());    
        //t1.input("q0,q1,q2,q3","0,1","0,1");    
        gecist g1=new gecist(t1);
